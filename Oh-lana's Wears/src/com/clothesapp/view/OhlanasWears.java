...
// Method to set up the CardLayout and add panels
    ...
    /**
     * Method to initialize the data, including the clothes list and table. This
     * method creates a list of clothes items and registers them into the
     * application.
     */
    ...
    /**
     * Helper method to refresh the table model with updated clothes data. It
     * clears the current table rows and repopulates them with the latest list
     * of clothes.
     */
    ...
    /**
     * Handles the action of updating the details of an existing product.
     *
    ...
    /**
     * Handles the action of deleting a product by its product code.
     *
    ...
    /**
     * Adds a new clothing item to the list and populates the table.
     *
     * @param clothes the ClothesModel object to be added
     * @param update a flag indicating if the table model should be updated
     */
    ...
    /**
     * Handles the "Add" button click event to add a new clothing item.
     * Validates user inputs, checks for duplicates, and adds the new item to
     * the list.
     *
    ...
    /**
     * Clears all input fields in the product form. Resets the text fields for
     * Resets the text fields for product details to empty strings.
     */
    ...
    /**
     * Loads a list of clothes into the specified JTable. Clears any existing
     * rows in the table before adding new data.
     *
     * @param list the list of ClothesModel objects to load into the table
     * @param table the JTable to populate with the list data
     */
    ...
    /**
     * Handles the action event triggered when a selection is made in the
     * JComboBox. This method sorts the list of clothes based on the selected
     * criteria (name, price, or code) and updates the table with the sorted
     * list.
     *
     * @param evt the ActionEvent triggered when an item is selected in the
     * JComboBox
     */
    private void jCBclothesActionPerformed(java.awt.event.ActionEvent evt) {                                           
    ...
    /**
     * Handles the mouse click event on the search label. This method sorts the
     * list of clothes by name, performs a binary search for the entered product
     * name, and displays the result in a message dialog.
     *
     * @param evt the MouseEvent triggered when the label is clicked
     */
